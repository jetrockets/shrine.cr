    ...
    module Instrumentation
      ...
      module ClassMethods
        ...
        def instrument(event_name, **payload, &block)
          ...
          payload = payload.merge(uploader: self)
      ...
      module InstanceMethods
        ...
        # private def _upload(io, location:, metadata:, upload_options: {}, **options)
        ...
        # private def get_metadata(io, metadata: nil, **options)
      ...
      class LogSubscriber
        ...
        private def format(properties = NamedTuple)
          properties.inspect
        end
